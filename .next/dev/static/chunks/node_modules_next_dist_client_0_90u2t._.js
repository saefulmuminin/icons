...
async function createFetch(url, headers, fetchPriority, shouldImmediatelyDecode, signal) {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        ...
        for(let n = 0; n < MAX_REDIRECTS; n++){
            ...
            fetchPromise = processed.then((param)=>{
                let { response } = param;
                return response;
            });
...
function createCacheNode(rsc, prefetchRsc, head, prefetchHead, bfcacheId) {
    let scrollRef = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : null;
    return {
        rsc,
        prefetchRsc,
        head,
...
map, varyPath) {
    let restrictToShell = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false;
    const isRevalidation = false;
