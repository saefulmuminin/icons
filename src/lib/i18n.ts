...
const en = {
  ...
  regDialCode: "Country code",
  regWhatsappHint: "812 3456 7890",
  regInstitution: "Name of institution",
  regInstitutionKind: "Kind of institution",
  ...
  regErrWhatsapp:
    "Write a number the committee can reach, country code and all.",
...
const id: Dict = {
  ...
  regDialCode: "Kode negara",
  regWhatsappHint: "812 3456 7890",
  regInstitution: "Nama institusi",
  regInstitutionKind: "Jenis institusi",
  ...
  regErrWhatsapp:
    "Tulis nomor yang bisa dihubungi, lengkap dengan kode negara.",
